 ...
 *  - "segmented": a prominent pill switch.
...
/**
 * Controlled status/workflow pill switch. Used as a page's sticky filter row —
 * the parent owns the active value. Horizontally scrollable on mobile.
 */
