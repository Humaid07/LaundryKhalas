 ...
 *
 * A lightweight, dependency-free listbox that replaces the native <select>.
 * Premium rounded styling, rose accent for the active/selected state, full
 * dark-mode support, and keyboard + screen-reader accessible.
 */
