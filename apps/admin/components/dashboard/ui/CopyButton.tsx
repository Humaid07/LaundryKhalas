 ...
 * Phase-5 micro-interaction (no global toast provider needed). Shows a check for
 * ~1.2s after copying; motion is opacity/colour only so prefers-reduced-motion
 * degrades cleanly. `value` is the text copied; `label` names it for a11y.
 */
