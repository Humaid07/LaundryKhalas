...
export const SECTIONS: Record<string, SectionDef> = {
  operations: {
    ...
    subsections: [
      ...
      { slug: "human-intervention", label: "Human Intervention", icon: AlertTriangle, description: "Conversations paused for abuse, threats or a customer request — claim, reply and release to AI.", kpis: [{ label: "Waiting", value: "0" }, { label: "Active", value: "0" }], status: { label: "Safety", tone: "danger" } },
