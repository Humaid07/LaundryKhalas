...
_SELECT = """
  select i.id, i.facility_id, i.order_id, i.order_ref, i.conversation_id,
         i.issue_type, i.title, i.message, i.severity, i.priority,
         i.assigned_team, i.assigned_internal_owner, i.status, i.requested_help,
         i.created_by_user_id, i.created_by_label, i.created_at, i.updated_at,
         i.resolved_at
    from facility_issues i
"""

_SELECT_WITH_FACILITY = """
  select i.id, i.facility_id, i.order_id, i.order_ref, i.conversation_id,
         i.issue_type, i.title, i.message, i.severity, i.priority,
         i.assigned_team, i.assigned_internal_owner, i.status, i.requested_help,
         i.created_by_user_id, i.created_by_label, i.created_at, i.updated_at,
         i.resolved_at, f.name as facility_name, f.code as facility_code
    from facility_issues i
    ...
    return await database.fetchrow(
        ...
        insert into facility_issues
            (facility_id, order_id, order_ref, issue_type, title, message,
             ...
             created_by_label, is_test_data, is_demo, environment, created_by_seed)
        values ($1, $2, $3, $4, $5, $6, $7, $8, 'open', $9, $10, $11,
                true, false, 'dev', false)
        returning id, facility_id, order_id, order_ref, issue_type, title, message,
                  severity, priority, assigned_team, assigned_internal_owner, status,
                  requested_help, created_by_user_id, created_by_label,
